...
export const CompassRotator = ({ rotation, onChange, visible }: CompassRotatorProps) => {
  ...
  return (
    // Position higher on mobile (bottom-32) to avoid floating shift toggle, normal position on desktop
    <div className="absolute bottom-32 lg:bottom-4 left-4 z-50 flex flex-col items-center gap-2">
      {/* Compass Circle */}
      <div
        ref={compassRef}
